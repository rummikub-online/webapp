import type { DrawStackDto } from "@/app/DrawStack/dtos/drawStack";
import { DrawStack, type IDrawStack } from "@/app/DrawStack/entities/DrawStack";
import type { GameBoardDto } from "@/app/GameBoard/dtos/gameBoard";
import { GameBoard, type IGameBoard } from "@/app/GameBoard/entities/GameBoard";
import { MAX_PLAYERS } from "@/app/Player/constants/player";
import type { PlayerDto } from "@/app/Player/dtos/player";
import { type IPlayer, Player } from "@/app/Player/entities/Player";
import { indexOfFirstPlayerByDrawedCard } from "@/app/Player/gamerules/firstToPlay";
import { isPlayerCountValid } from "@/app/Player/gamerules/isCountValid";
